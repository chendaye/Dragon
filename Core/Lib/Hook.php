...
class Hook
{
    ...
    {
        App::$debug && Debug::record('behavior_start', 'time');
        ...
        if (App::$debug) {
            Debug::record('behavior_end', 'time');
            Log::log('[ BEHAVIOR ] Run ' . $class . ' @' . $tag . ' [ RunTime:' . Debug::rangeTime('behavior_start', 'behavior_end') . 's ]', 'info');
        }
        return $result;
    }
